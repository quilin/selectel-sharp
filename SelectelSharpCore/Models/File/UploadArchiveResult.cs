...
namespace SelectelSharpCore.Models.File
{
    ...
    {
        [JsonProperty("Response Status")] public string ResponseStatus { get; set; }

        [JsonProperty("Response Body")] public string ResponseBody { get; set; }

        public ReadOnlyCollection<string> Errors { get; set; }

        [JsonProperty("Number Files Created")] public int NumberFilesCreated { get; set; }

        [Header(HeaderKeys.ExtractId)] public string ExtractId { get; set; }
